      ...
      <section class="contact">
        ...
        <form action="pay.html" method="POST">
          <div class="row">
              ...
              <div class="col-xs-12">
                <input type="text" class="form-control" name="amount" placeholder="Donatie" required>
              </div>


              <div class="col-xs-12 col-md-6">
                <input type="text" class="form-control" name="fl" placeholder="Voorletter(s)" required>
              </div>
              <div class="col-xs-12 col-md-6">
                <input type="text" class="form-control" name="ins" placeholder="Tussenvoegsel">
              </div>


              <div class="col-xs-12">
                <input type="text" class="form-control" name="lname" placeholder="Achternaam" required>
              </div>


              <div class="col-xs-12 col-md-4">
                <input type="text" class="form-control" name="postc" placeholder="Postcode" required>
              </div>
              <div class="col-xs-12 col-md-4">
                <input type="text" class="form-control" name="num" placeholder="Huisnummer" required>
              </div>
              <div class="col-xs-12 col-md-4">
                <input type="text" class="form-control" name="add" placeholder="Toevoeging">
              </div> 
              ...
              <div class="col-xs-12">
                <input type="text" class="form-control" name="mail" placeholder="E-mailadres" required>
              </div>
            </div>


          <button type="submit" class="btn-contact">Versturen</button>
        </form>
      </section>
    </div>
