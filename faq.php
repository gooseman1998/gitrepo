  ...
  <body>
    ...
    <section>
      <div class="faq">
        ...
        <p>
          De meest voorkomende vragen en antwoorden hebben wij op deze pagina voor u onder elkaar gezet. Staat uw vraag er niet tussen, stel deze dan gerust per <a href="contact.html"> mail </a> aan ons.
        </p>

        <div class="accordion" id="accordionExample">
          <div class="card" data-toggle="collapse" data-target="#cVriend" aria-expanded="false" aria-controls="cVriend">
            ...
            <div id="cVriend" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
              <div class="card-body">
                U kunt het contact formulier invullen dan ontvangen wij u gegevens en nemen we contact met u op.
              </div>
            </div>
          </div>
          ...
          <div class="card" data-toggle="collapse" data-target="#cProj" aria-expanded="false" aria-controls="cProj">
            <div class="card-header" id="headingTwo">
              <h2 class="mb-0">
                <button class="btn btn-link collapsed" type="button" >
                  Kan ik mij aanmelden voor projecten?
                </button>
              </h2>
            </div>
            <div id="cProj" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
              <div class="card-body">
                 U kunt u gegevens achter laten op het contact formulier dan nemen we u contact op om te bepalen hoe u ons kunt helpen / ondersteunen bij de projecten
              </div>
            </div>
          </div>
          ...
          <div class="card" data-toggle="collapse" data-target="#cDon" aria-expanded="false" aria-controls="cDon">
            <div class="card-header" id="headingTwo">
              <h2 class="mb-0">
                <button class="btn btn-link collapsed" type="button" >
                  Wat wordt er met de donaties gedaan ?
                </button>
              </h2>
            </div>
            <div id="cDon" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
              <div class="card-body">
                Met de gelden die voortvloeien uit donaties ondersteunen we verschillende projecten zoals op de site beschreven.
              </div>
            </div>
          </div>
      </div>
