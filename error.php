...
<html lang="en">
  ...
  <body>
    ...
    <section class="error">
      <h1>Oops</h1>
      <p>
         Er is iets mis gegaan met de donatie, controleer de gegevens en probeer het opnieuw. Blijft het probleem zich voordoen, neem dan <a href="contact.html">contact</a> met ons op.
      </p>
    </section>
