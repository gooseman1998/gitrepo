  ...
  <body>
    ...
    <section>
      <div class="over">
        <h1>Circus</h1>
        <p>
			Eén van de projecten waaraan we dit jaar financiële ondersteuning bieden is het ‘Circus in de Zorg’. Maandag 8 juli en woensdag 10 juli zal het Circus de tent opzetten bij 2 locaties van Zorggroep Apeldoorn en omstreken.
			Er worden op beide dagen 3 voorstellingen gegeven waarbij cliënten van alle locaties welkom zijn.
			Cliënten kunnen zonder eigen bijdrage hiervan komen genieten. Ook het vervoer van en naar de voorstelling wordt verzorgd.

        </p>
        
        <p>
			De voorstelling duurt een uur waarin verschillende acts gepresenteerd zullen worden.
			Na de voorstelling is er voor iedereen een heerlijk portie poffertjes. Zo ziet u dat we niet alleen financieel bijdragen maar ook vaak helpen de feestvreugde te vergroten en op locatie poffertjes bakken.
			Als vast-begunstigde van het ‘Schmalhausenfonds-ars donandi ‘ hebben we gekozen hun bijdrage ook te gebruiken om deze voorstellingen mogelijk te maken.
        </p>
      </div>
    </section>
